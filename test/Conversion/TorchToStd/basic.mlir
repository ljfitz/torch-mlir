...
// CHECK-LABEL:   func @torch.aten.sqrt.int(
...
func @torch.aten.sqrt.int(%arg0: !torch.int) -> !torch.float {
  %0 = torch.aten.sqrt.int %arg0 : !torch.int -> !torch.float
  return %0 : !torch.float
}

// CHECK-LABEL:   func @torch.aten.any.bool() -> !torch.bool {
...
func @torch.aten.any.bool() -> !torch.bool {
...
// CHECK-LABEL:   func @torch.aten.Bool.float(
...
func @torch.aten.Bool.float(%arg0: !torch.float) -> !torch.bool {
  %0 = torch.aten.Bool.float %arg0 : !torch.float -> !torch.bool
  return %0 : !torch.bool
}

// CHECK-LABEL:   func @torch.aten.Bool.int(
...
// CHECK:           %[[OUT:.*]] = torch_c.from_i1 %[[SELECT]]
// CHECK:           return %[[OUT]] : !torch.bool
func @torch.aten.Bool.int(%arg0: !torch.int) -> !torch.bool {
